...
keys = [
    ...
    # GnuChanGUI
    Key([mod], "t", lazy.spawn(f"python3 {user_home}/.config/qtile/Programs/SimpleTimer.py")),
    Key([mod], "c", lazy.spawn(f"python3 {user_home}/.config/qtile/Programs/SimpleCalculator.py")),
    Key([mod, "shift"], "t", lazy.spawn(f"python3 {user_home}/.config/qtile/Programs/SimpleTextEditor.py")),
    Key([mod], "r", lazy.spawn(f"python3 {user_home}/.config/qtile/Programs/SimpleProgramRunner.py")),
...
os.popen(f"python {user_home}/.config/qtile/autostart.py")
